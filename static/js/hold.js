...
function show_order_list() {
    ...
    $.each(resorderlist, function(k, v) {
     ...
     //            }
			...
			if(closeprice>=0){
				var sy_class='in_money'
			}else{
				var sy_class='out_money'
			}
            html += '<li ng-repeat="o" style="display: flex;" class="">\
                        <section style="flex:1;width:auto;">\
                            ...
                            <p style="margin: 0px;" class="ng-binding ' + sy_class + '">' + closeprice + '</p>\
			...
			$.each(res_list, function(k, v) {
			    ...
			    html += '<li ng-repeat="o" style="display: flex;" onclick="get_hold_order(' + v.id + ')" >\
			                <section style="flex:1;width:auto;">\
			                    ...
			                    <p class="ng-binding ' + sy_class + '">' + cc + '</p>\
...
function get_hold_order(oid) {
    ...
    $.get(url, function(data) {
        ...
        $('.order-modal-content .fangxiang').html(data.ostyle?(I18n.t('product.buyDown')+'/')+data.endprofit+'秒':(I18n.t('product.buyUp')+'/')+data.endprofit+'秒');
